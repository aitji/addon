...
execute unless score api "aitjilib" matches 1 if score counter "aitjilib" matches ..0 run tellraw @a {"rawtext":[{"translate":"§c§cAnti Spam §l§cไม่สามารถ§r§7ติดตั้งได้\n\nกรุณา§cเปิด Beta APIs§7 เพื่อให้แอดออนนี้สามารถใช้งานได้\nหากต้องการข้อมูลเพิ่มเติมสำหรับการลงแอดออน §caitji.is-a.dev/support#how-do-i-install-x-addon"}]}
